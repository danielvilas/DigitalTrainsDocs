...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|c|}
        ...
        \connectorinfo{Codigo}{EN11-HSM1BQ30}{
            \tabitem \textbf{Fabricante}: TR Electronics
        }
        \cline{1 - 2}
        \connectorblockinfo{Uso}{UI Dcc Decoder Config}
        \connectorblockinfo{Ubicacion}{TR}
        \beginConnectorTable{Encoder HW-040 (EC11)}
        \multirow{4}{*}{\makecell{HW-040 \\ En PCB}}
        \connectordata{
            \begin{scope}
                \clip (0,0) rectangle  +(3,1.5);
                \node[inner sep=0pt] at (1.5,0.75)
                    {\includegraphics[scale=.09]{pictures/EncModulo.jpg}};
            \end{scope}
        }{
            \draw (0,0) rectangle (3,1.5) ;
        }{Aliexpress}{HW-0404} {5V} {10mA}
        \cline{1 - 2}
        \connectorblockinfo{Uso}{UI Dcc Decoder Config}
