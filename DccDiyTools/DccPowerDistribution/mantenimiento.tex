...
\begin{tcolorbox}
   \item Añadir Test Points, de voltaje (Drive, 5, 3.3V, VDcc, deco5 y decoGnd) 
	\item Añadir Tespoints de Gate Q4
	\item Que se vean los Ux en el silk
	\item Cambiar los Diodos, por unos mejores (th)
	\item aislar decoGND
	\item Mejorar ERC (NetTies)
	\item Añadir Led VCc, VDcc y VDcc out(se esta usando Dcc).
	\item Añadir Filtro Pi a Vdrive (asi se aplica a los dos)
	\item revisar si se puede tener CC only y DCC a la vez
	\item ¿Mover Jp3 y Jp4 despues del ACK y antes de los condensadores...?
\end{tcolorbox}
\end{itemize}
