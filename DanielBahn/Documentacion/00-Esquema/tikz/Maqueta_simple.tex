...
\newcommand{\paintYardZones}[2][black]{
	\draw[color=#1,line width=#2] (0.05,2.4) -- (1.95,2.4)
	(2.05,2.4) -- (3.95,2.4);

	\draw[color=#1,line width=#2] (1.05,2.7) -- (1.95,2.7)
	(2.05,2.7) -- (3.95,2.7);

	\draw[color=#1,line width=#2] (-.05,2.7) -- (-1.95,2.7) 
	(-2.05,2.7)--(-2.95,2.7); 
	\draw[color=#1, line width=#2]
	($(-0.5,2.4)!0.475!0:(-1.8,2.1)$) -- (-0.5,2.4) --(0.8,2.7)
	(0.95,2.7) --(0.05,2.7)
	(-0.05,2.4) --(-0.5,2.4) 
;
}
...
\newcommand{\paintMainZones}[2][black]{
 	\draw[color=#1,line width=#2] 
 	(1.05,2.1) -- (1.95,2.1)
 	($(2,0)!1!89:(4.1,0)$) arc (89:1:2.1)
    ($(2,0)!1!-1:(4.1,0)$) arc (-1:-89:2.1)
    (4.1,-0.04) -- ($(2,-0.3)!1!-1:(4.1,-0.3)$) arc (-1:-89:2.1)
    (0.75,-2.1) -- (0.05,-2.1)
    (-0.05,-2.1) -- (-1.95,-2.1)
    ($(-2,-0.3)!1!-1:(-2,-2.4)$) arc(-91:-179:2.1) --
    ($(-2,-0)!1!1:(-4.1,-0)$) arc(181:269:2.1)
 	($(-2,-0)!1!-1:(-4.1,-0)$) arc(179:91:2.1)
 	(-0.95,2.1) -- (-0.05,2.1)
    (1.8,-2.1) -- ($(1.8,-2.1)!.475!0:(0.2,-1.8)$)
 	(1.95,-2.1) -- (0.85,-2.1)
    (0.05,2.1) -- (0.95,2.1)
    (0.2,2.1) -- ($(0.2,2.1)!.475!0:(1.5,1.8)$)
 	(-1.95,2.1)--(-1.05,2.1)
    (-1.8,2.1) -- ($(-1.8,2.1)!0.475!0:(-0.5,2.4)$);
}
...
\newcommand{\paintTerminusZones}[2][black]{
 	\draw[color=#1,line width=#2]
 	($(2,0)!1!1:(3.8,0)$) arc(1:89:1.8)
    (1.95,1.8) -- (1.5,1.8) -- ($(1.5,1.8)!0.475!0:(0.2,2.1)$);
	
    \draw[color=#1,line width=#2] 
 	(1.25,-1.8) -- (1.95,-1.8)
    ($(2,0)!1!1:(2,-1.8)$)arc(-89:-1:1.8);
 	\draw [color=#1,line width=#2]
 	(0.05,-1.8) -- (1.15,-1.8)
    (0.2,-1.8) -- ($(0.2,-1.8)!.475!0:(1.8,-2.1)$)
 ;
	\draw[color=#1,line width=#2] (-1.95,-1.8) -- (-0.05,-1.8);
}
