\begin{tikzpicture}
    ...
    %R1 Circuit
    \draw[line width=2pt](-1,-1.8) -- (2,-1.8) arc(-90:90:1.8)
    -- (1.5,1.8) -- (0.2,2.1);
    \draw[line width=2pt] (0.2,-1.8) -- (1.8,-2.1);

    %Playa de vias
    \draw[line width=2pt](-4.3,2.4) -- (4.3,2.4);
    \draw[line width=2pt] (-1.8,2.1) -- (-0.2,2.4);
    \draw[line width=2pt] (2.2,2.4) -- (4.2,2.0);
