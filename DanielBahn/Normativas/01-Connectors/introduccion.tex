...
Esta maqueta tiene de forma de isla, es decir, no llega a tocar ninguna pared, y no tiene
bucles. Por lo que con el sentido de circulacion Eastbound (Este) es suficiente para polarizar
la maqueta. En este caso el carril exterior se corresponde con el rail derecho y el carril interior
se corresponde con el rail izquierdo\sidenote{Nos sera util para la definicion de cables}.  
