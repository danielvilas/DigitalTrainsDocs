...
\begin{figure}[H]
    \centering
    \input{tikz/SegmentosDetail.tex}
...
Lo que se desea para esta version es poder controlar el desvio mediante DCC o LCB. Controlar semaforos
